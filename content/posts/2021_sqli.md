...
# Injection Attacks
An injection attack is where a user can trick a server to run a command through an input, header or URL. It is currently in the third position of the [OWASP Top 10](https://owasp.org/Top10/).
