"use strict";!function(b){function d(){}function a(a,b){for(var c=a.querySelectorAll("input"),d=0;d<c.length;d++)c[d].disabled=b}function g(a){var b="Malformed action: "+a,a=k.exec(a);if(!a)throw new Error(b);if(a={base:a[1],key:a[2],bucket:a[4]||""},a.base!==j._base||!a.key.length)throw new Error(b);return a.url=a.base+"/"+a.key+"/"+a.bucket,a}function f(a){this.el=a.querySelector("."+j.cssBase+"__submit")}function h(a,b,c){var d=getComputedStyle(a,"::after"),a=d.animationName;a&&"none"!==a?function(a,b){clearTimeout(o),a=1e3*parseFloat(a),o=setTimeout(b,a-10)}(d.animationDuration,b):c()}var i="string"==typeof __pageclip_base?__pageclip_base:"https://send.pageclip.co",j={_base:i,_successTemplate:"<div class=\"pageclip-form__success__message\">Message Sent, Thank You!</div>",cssBase:"pageclip-form",form:function form(d,h){if(h=h||{},null==d)throw new Error("form() must be passed an HTMLFormElement or String, not null");if("string"==typeof d&&(d=document.querySelector(d)),!((d=b.jQuery&&d instanceof b.jQuery?d[0]:d)instanceof b.HTMLFormElement))throw new Error("form() must be passed an HTMLFormElement or String");var k=g(d.getAttribute("action")),m={"X-REQMETHOD":"form-v1","Content-Type":"application/json"},o=j.cssBase,p=j.cssBase+"--submitting",i=j.cssBase+"--error",a=j.cssBase+"--success",c=h.successTemplate||j._successTemplate,q=new f(d);d.classList.add(o),d.onsubmit=function(b){b.preventDefault(),q.start();var b=JSON.stringify(j.formToJSON(d)),f=!1!==(!h.onSubmit||h.onSubmit());f&&(d.classList.add(p),j._showSubmitting(d),j._send(k.key,k.url,m,b,h,function(b,e){f&&j._hideSubmitting(d),d.classList.remove(p),d.classList.add(b?i:a),!1===(!h.onResponse||h.onResponse(b,e))||b||j._showSuccess(d,c),b?console.error(b.message||b):d.reset(),setTimeout(function(){q.stop()},200)}))}},send:function send(a,b,c,d){b=j._base+"/"+a+"/"+(b||""),j._send(a,b,{"X-REQMETHOD":"send-v1","Content-Type":"application/json"},JSON.stringify(c),{},d)},formToJSON:function formToJSON(a){for(var b,c=a.elements,d={},e=0;e<c.length;e++)b=c[e],b.name.trim()&&("radio"!==b.type&&"checkbox"!==b.type||b.checked)&&(d[b.name]=b.value);return d},_send:function _send(a,b,c,d,e,f){try{j._xhrFetch(a,b,c,d,f)}catch(b){j._sendError(a,b),f(b)}},_xhrFetch:function _xhrFetch(a,c,e,f,g){var h,k=j._xhr();for(h in e=function(a,b){if(b)for(var c in b)a[c]=b[c];return a}({"X-REQTRANSPORT":"xhr","X-HASFETCH":!!b.fetch},e),g=g||d,k.onreadystatechange=function(){try{var b,c;4===k.readyState&&(b=k.response,c=200===k.status?null:new Error("Error submitting data: "+(b?b.error:"Unknown Error")),g(c,c?null:b))}catch(b){j._sendError(a,b),g(b)}},k.open("POST",c),k.responseType="json",e)k.setRequestHeader(h,e[h]);k.send(f)},_xhr:function _xhr(){return new(b.XMLHttpRequest||ActiveXObject)("MSXML2.XMLHTTP.3.0")},_sendError:function _sendError(a,b){var c="{\"error\": \""+(b.stack||b.message||b+"").replace(/"/g,"\\\"").replace(/\n/g,"\\n")+"\"}",b=j._xhr();b.open("POST",j._base+"/error/"+(a||"")),b.setRequestHeader("Content-Type","application/json"),b.setRequestHeader("X-REQMETHOD","send-v1"),b.send(c)},_showSubmitting:function _showSubmitting(b){a(b,!0)},_hideSubmitting:function _hideSubmitting(b){a(b,!1)},_showSuccess:function _showSuccess(a,b){var c=document.createElement("div");c.classList.add(j.cssBase+"__success"),c.innerHTML=b,c.onclick=function(){j._hideSuccess(a)},a.appendChild(c)},_hideSuccess:function _hideSuccess(a){a=a.querySelector("."+j.cssBase+"__success"),a&&a.remove()}},k=/^(.+)\/([\w\d]{32})(\/([^\/]*))?$/,i="__submit--",l=j.cssBase+i+"start-loading",m=j.cssBase+i+"loading",n=j.cssBase+i+"end-loading";f.prototype.start=function(){var a;this.el&&(this.el.disabled=!0,(a=this.el.classList).remove(n),a.remove(m),a.add(l),h(this.el,function(){a.remove(l),a.add(m)},function(){a.add(m),a.remove(l)}))},f.prototype.stop=function(){function a(){b.remove(n)}var b;this.el&&(this.el.disabled=!1,(b=this.el.classList).remove(l),b.remove(m),b.add(n),h(this.el,a,a))};var o=null;"undefined"!=typeof module&&void 0!==module.exports?(module.exports=j,module.exports.normalizeAction=g):(window.Pageclip=j,function(){for(var a=document.querySelectorAll("."+j.cssBase),b=0;b<a.length;b++)j.form(a[b])}())}(window||global);
